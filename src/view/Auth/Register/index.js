  ...
  const [passwordCheck,setPasswordCheck] = useState('');
    ...
    return (
        ...
        <Form onSubmit={onSubmit} style={{padding:10}}>
            ...
            <div>
                <label htmlFor="user-password-check">*Confirm Password</label><br/>
                <Input name="user-password-check" type="password" value={passwordCheck} required onChange={onChangePasswordChk} />
                {passwordError && <div style={{color : 'red'}}>비밀번호가 일치하지 않습니다.</div>}
            </div>
            <div>
                <Checkbox name="user-term" value={term} onChange={onChangeTerm}>Email과 개인정보를 입력하는 데 동의하십니까?
                다른 곳에 이용되지 않을 것입니다.</Checkbox>
